...
| 1406 | [Stone Game III](https://leetcode.com/problems/stone-game-iii) | Hard | `Array` `Dynamic Programming` `Game Theory` `Math` |
...
| 1485 | [Clone Binary Tree With Random Pointer](https://leetcode.com/problems/clone-binary-tree-with-random-pointer) | Medium | `Binary Tree` `Breadth-First Search` `Depth-First Search` `Hash Table` `Tree` |
| 1490 | [Clone N-ary Tree](https://leetcode.com/problems/clone-n-ary-tree) | Medium | `Breadth-First Search` `Depth-First Search` `Hash Table` `Tree` |
...
| 1858 | [Longest Word With All Prefixes](https://leetcode.com/problems/longest-word-with-all-prefixes) | Medium | `Array` `Depth-First Search` `String` `Trie` |
...
| 2107 | [Number of Unique Flavors After Sharing K Candies](https://leetcode.com/problems/number-of-unique-flavors-after-sharing-k-candies) | Medium | `Array` `Hash Table` `Sliding Window` |
...
| 3093 | [Longest Common Suffix Queries](https://leetcode.com/problems/longest-common-suffix-queries) | Hard | `Array` `String` `Trie` |
